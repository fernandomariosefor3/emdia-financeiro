const projects = [
  ...
  },
  {
    ...
    desc: "Experiência mobile fluida com design responsivo, funcionando como app nativo em qualquer dispositivo.",
    tags: ["PWA", "Responsivo", "Mobile-First"],
  ...
  },
  {
    ...
    desc: "Arquitetura de segurança com autenticação Firebase, criptografia e conformidade com a LGPD.",
    tags: ["Firebase Auth", "Criptografia", "LGPD"],
  ...
  },
  {
    ...
    desc: "Acompanhe parcelas, juros e prazos com alertas automáticos de vencimento em tempo real.",
    tags: ["Parcelas", "Alertas", "Juros"],
  ...
  },
  {
    ...
    tags: ["TailwindCSS", "A11y", "Design Tokens"],
